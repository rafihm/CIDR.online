    ...
    <header class="byte-check-header mdl-layout__header">
        ...
        <form method="get" action="/results">
            <div class="byte-check-input mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-color-text--blue-grey-600 mdl-shadow--2dp">
                <input class="mdl-textfield__input" type="text" id="url-check" value="" name="resource" onsubmit="return validateForm()">
                         ...
                         <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp" style="width: 100%">
                                ...
                                <?php        
                                        echo '<tr>
                                          <td class="mdl-data-table__cell--non-numeric" style="font-size: 15px">IP address</td>
                                          <td class="byte-check-info-value mdl-typography--subhead" style="font-size: 15px">' . $decoded_json->ip_address->quads . '</td>
                                        <td class="byte-check-info-value mdl-typography--subhead" style="font-size: 15px">' . $decoded_json->ip_address->ip_address->hex . '</td>
                                        <td class="byte-check-info-value mdl-typography--subhead" style="font-size: 15px">' . $decoded_json->ip_address->binary . '</td>
                                        </tr>';
                                ?>
                                <?php        
                        ...
                        <div class="mdl-card byte-check-waterfall" style="width: 100%">
                         ...
                         <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp" style="width: 100%">
                                ...
                                ?> 
                                        ...
                                        <tr>
                                          <td class="mdl-data-table__cell--non-numeric" style="font-size: 15px">Acrylic (Transparent)</td>
                                          <td class="byte-check-info-value mdl-typography--subhead" style="font-size: 15px">25</td>
                                        </tr>
                                        <tr>
                                          <td class="mdl-data-table__cell--non-numeric" style="font-size: 15px">Plywood (Birch)</td>
                                          <td class="byte-check-info-value mdl-typography--subhead" style="font-size: 15px">50</td>
                                        </tr>
                                        <tr>
                                          <td class="mdl-data-table__cell--non-numeric" style="font-size: 15px">Laminate (Gold on Blue)</td>
                                          <td class="byte-check-info-value mdl-typography--subhead" style="font-size: 15px">10</td>
                                        </tr>
                                      </tbody>
                                    </table>
